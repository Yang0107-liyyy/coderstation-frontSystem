...
import { Card, Image, Upload, message, Modal, Form, Button, Input } from 'antd';
import { PlusOutlined } from '@ant-design/icons';
import PageHeader from "../components/PageHeader";
import PersonalInfoItem from '../components/PersonalInfoItem';
import { updateUserInfoAsync, clearUserInfo, changeLoginStatus } from '../redux/userSlice';
...
function Personal(props) {
    ...
    /**
     * 用户输入密码时，更新 passwordInfo
     * @param {*} newInfo 用户输入的值
     * @param {*} key passwordInfo 对应的属性名
     */
